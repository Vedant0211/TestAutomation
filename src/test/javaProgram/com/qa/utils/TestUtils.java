...
public class TestUtils{
	...
	public HashMap<String, List<String>> xlsData(InputStream file) {
	    HashMap<String, List<String>> sheetDataMap = new HashMap<>();
	    ...
	    try {
	        ...
	        for (int sheetIndex = 0; sheetIndex < numberOfSheets; sheetIndex++) {
	            ...
	            for (Row row : sheet) {
	                for (Cell cell : row) {
	                    // Assuming the elements are in the first column (index 0)
